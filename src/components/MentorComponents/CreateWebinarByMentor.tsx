...
interface CreateWebinarByMentorProps {
...
const CreateWebinarByMentor: React.FC<CreateWebinarByMentorProps> = ({ setOpenWebinarModel, refreshWebinars }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${BackendUrl}/mentor/create-webinar`,
        form,
        {
          headers: {
...
export default CreateWebinarByMentor;
