...
const LoyaltyCard: React.FC<LoyaltyCardProps> = ({ coins, username }) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(headerRef.current, { opacity: 0, y: -15, duration: 0.5, delay: 0.2 });
      gsap.from(usernameRef.current, { opacity: 0, x: -15, duration: 0.5, delay: 0.3 });
      gsap.from(coinsContainerRef.current, { opacity: 0, scale: 0.8, duration: 0.6, delay: 0.4 });
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div ref={headerRef} className="flex items-center justify-between mb-4">
          <h3 className="text-2xl font-bold">FMC Coins</h3>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div ref={coinsContainerRef} className="text-center">
            ...
            <p ref={coinsNumberRef} className="text-5xl font-bold mb-2">0</p>
